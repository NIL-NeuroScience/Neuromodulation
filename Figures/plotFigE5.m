...
subAvg.FigE5.Unf.LR_perf = NaN(500,600,numel(NE_order));
subAvg.FigE5.Unf.IRFx2_perf = NaN(500,600,numel(NE_order));
subAvg.Fig2.LR_perf = NaN(500,600,numel(NE_order));
subAvg.Fig2.IRFx2_perf = NaN(500,600,numel(NE_order));
subAvg.FigE5.Unf.LR_A = NaN(500,600,numel(NE_order));
subAvg.FigE5.Unf.LR_B = NaN(500,600,numel(NE_order));
subAvg.FigE5.Unf.IRFx2_A = NaN(500,600,numel(NE_order));
subAvg.FigE5.Unf.IRFx2_B = NaN(500,600,numel(NE_order));
subAvg.FigE5.Unf.tA = NaN(numel(NE_order),1);
subAvg.FigE5.Unf.tB = NaN(numel(NE_order),1);
subAvg.FigE5.Unf.IRFx2_IRF = NaN(151,2,numel(NE_order));
subAvg.FigE5.Shu.LR_A = NaN(500,600,numel(NE_order));
subAvg.FigE5.Shu.LR_B = NaN(500,600,numel(NE_order));
subAvg.FigE5.Shu.IRFx2_A = NaN(500,600,numel(NE_order));
subAvg.FigE5.Shu.IRFx2_B = NaN(500,600,numel(NE_order));
subAvg.FigE5.Shu.tA = NaN(numel(NE_order),1);
subAvg.FigE5.Shu.tB = NaN(numel(NE_order),1);
subAvg.FigE5.Shu.IRFx2_IRF = NaN(151,2,numel(NE_order));

for i = 1:numel(NE_order)
    subAvg.FigE5.Unf.LR_perf(:,:,i) = mean(tmp.Unf.LR_perf(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Unf.IRFx2_perf(:,:,i) = mean(tmp.Unf.IRFx2_perf(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Shu.LR_perf(:,:,i) = mean(tmp.Shu.LR_perf(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Shu.IRFx2_perf(:,:,i) = mean(tmp.Shu.IRFx2_perf(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Unf.LR_A(:,:,i) = mean(tmp.Unf.LR_A(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Unf.LR_B(:,:,i) = mean(tmp.Unf.LR_B(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Unf.IRFx2_A(:,:,i) = mean(tmp.Unf.IRFx2_A(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Unf.IRFx2_B(:,:,i) = mean(tmp.Unf.IRFx2_B(:,:,NE_order(i).Runs),3,'omitnan');
    ...
    subAvg.FigE5.Unf.IRFx2_IRF(:,:,i) = mean(cat(3,unfiltered.IRFx2_IRF{NE_order(i).Runs}),3);
    subAvg.FigE5.Shu.LR_A(:,:,i) = mean(tmp.Shu.LR_A(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Shu.LR_B(:,:,i) = mean(tmp.Shu.LR_B(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Shu.IRFx2_A(:,:,i) = mean(tmp.Shu.IRFx2_A(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Shu.IRFx2_B(:,:,i) = mean(tmp.Shu.IRFx2_B(:,:,NE_order(i).Runs),3,'omitnan');
    subAvg.FigE5.Shu.LR_tA(i) = mean([shuffled.LR_tA{NE_order(i).Runs}]);
    subAvg.FigE5.Shu.LR_tB(i) = mean([shuffled.LR_tB{NE_order(i).Runs}]);
    subAvg.FigE5.Shu.IRFx2_IRF(:,:,i) = mean(cat(3,shuffled.IRFx2_IRF{NE_order(i).Runs}),3);
end
...
f = figure;
f_plotMap(mean(subAvg.FigE5.Unf.LR_A,3,'omitnan').*plotBM,cmp=cmpbbr,clim=[-1 1],title='LR A',clabel='');
% for i = 1:12
...
f = figure;
f_plotMap(mean(subAvg.FigE5.Unf.LR_B,3,'omitnan').*plotBM,cmp=cmpbbr,clim=[-1 1],title='LR B',clabel='');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
f = figure;
f_plotMap(mean(subAvg.FigE5.Unf.LR_perf,3,'omitnan').*plotBM,cmp=cmpvir,clim=[0 1],title='LR Performance',clabel='r');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
f = figure;
f_plotMap((mean(subAvg.FigE5.Unf.LR_perf,3,'omitnan')-mean(subAvg.Fig2.g_LR_perf,3,'omitnan')).*plotBM,cmp=cmpbbr,clim=[-1 1],title='LR vs. Global IRF',clabel='\Deltar');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
f = figure;
f_plotMap(mean(subAvg.FigE5.Unf.IRFx2_A,3,'omitnan').*plotBM,cmp=cmpbbr,clim=[-1 1],title='IRFx2 A',clabel='');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
f = figure;
f_plotMap(mean(subAvg.FigE5.Unf.IRFx2_B,3,'omitnan').*plotBM,cmp=cmpbbr,clim=[-1 1],title='IRFx2 B',clabel='');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
error1 = std(subAvg.FigE5.Unf.IRFx2_IRF(:,1,:),0,3)/sqrt(numel(NE_order));
f_plotLineError(-5:0.1:10,meanSig1,error1,color=c_Ca);
meanSig2 = mean(subAvg.FigE5.Unf.IRFx2_IRF(:,2,:),3);
error2 = std(subAvg.FigE5.Unf.IRFx2_IRF(:,2,:),0,3)/sqrt(numel(NE_order));
...
f = figure;
f_plotMap(mean(subAvg.FigE5.Unf.IRFx2_perf,3,'omitnan').*plotBM,cmp=cmpvir,clim=[0 1],title='IRFx2 Performance',clabel='r');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
f = figure;
f_plotMap((mean(subAvg.FigE5.Unf.IRFx2_perf,3,'omitnan')-mean(subAvg.Fig2.g_IRFx2_perf,3,'omitnan')).*plotBM,cmp=cmpbbr,clim=[-1 1],title='IRFx2 vs. Global IRF',clabel='\Deltar');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
f = figure;
f_plotMap(mean(subAvg.FigE5.Shu.LR_A,3,'omitnan').*plotBM,cmp=cmpbbr,clim=[-1 1],title='LR A',clabel='');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
f = figure;
f_plotMap(mean(subAvg.FigE5.Shu.LR_B,3,'omitnan').*plotBM,cmp=cmpbbr,clim=[-1 1],title='LR B',clabel='');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
f = figure;
f_plotMap((mean(subAvg.FigE5.Shu.LR_perf,3,'omitnan')-mean(subAvg.Fig1.inv_perf,3,'omitnan')).*plotBM,cmp=cmpbbr,clim=[-1 1],title='LR vs. Global IRF',clabel='\Deltar');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
f = figure;
f_plotMap(mean(subAvg.FigE5.Shu.IRFx2_A,3,'omitnan').*plotBM,cmp=cmpbbr,clim=[-1 1],title='IRFx2 A',clabel='');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
f = figure;
f_plotMap(mean(subAvg.FigE5.Shu.IRFx2_B,3,'omitnan').*plotBM,cmp=cmpbbr,clim=[-1 1],title='IRFx2 B',clabel='');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
...
error1 = std(subAvg.FigE5.Shu.IRFx2_IRF(:,1,:),0,3)/sqrt(numel(NE_order));
f_plotLineError(-5:0.1:10,meanSig1,error1,color=c_Ca);
meanSig2 = mean(subAvg.FigE5.Shu.IRFx2_IRF(:,2,:),3);
error2 = std(subAvg.FigE5.Shu.IRFx2_IRF(:,2,:),0,3)/sqrt(numel(NE_order));
f_plotLineError(-5:0.1:10,meanSig2,error2,color=c_GRAB);
xlim([-2 7]);
xlabel('Time (s)');
ylabel('a.u.');
...
f = figure;
f_plotMap((mean(subAvg.FigE5.Shu.IRFx2_perf,3,'omitnan')-mean(subAvg.Fig1.inv_perf,3,'omitnan')).*plotBM,cmp=cmpbbr,clim=[-1 1],title='IRFx2 vs. Global IRF',clabel='\Deltar');
% for i = 1:12
%     f_plotAllenRegion(i,2,linewidth=2,color=[0 0 0]);
% end
colorbar off;
