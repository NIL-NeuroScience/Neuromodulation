...
f = figure;
meanSig1 = mean(subAvg.Spectra.low_NE_Ca,2);
error1 = std(subAvg.Spectra.low_NE_Ca,0,2)/sqrt(M_NE);
f_plotLineError(spectra.fr,spectra.fr.*meanSig1,spectra.fr.*error1,color=c_darkCyan,log=1,lineWidth=3);
meanSig2 = mean(subAvg.Spectra.high_NE_Ca,2);
error2 = std(subAvg.Spectra.high_NE_Ca,0,2)/sqrt(M_NE);
...
f = figure;
meanSig1 = mean(subAvg.Spectra.low_NE_HbT,2);
error1 = std(subAvg.Spectra.low_NE_HbT,0,2)/sqrt(M_NE);
f_plotLineError(spectra.fr,spectra.fr.*meanSig1,spectra.fr.*error1,color=c_darkCyan,log=1,lineWidth=3);
meanSig2 = mean(subAvg.Spectra.high_NE_HbT,2);
error2 = std(subAvg.Spectra.high_NE_HbT,0,2)/sqrt(M_NE);
f_plotLineError(spectra.fr,spectra.fr.*meanSig2,spectra.fr.*error2,color=c_Orange,log=1,lineWidth=3);
set(gca,'YScale','linear','FontSize',14);
xlim([0.01 5]);
xlabel('F (Hz)');
...
f = figure;f_plotAllenMap(mean(subAvg.Spectra.lowF_lowNE_Ca,2),cmp=cmpinf,mask=plotBM,cRange=[0,1]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_E1.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

f = figure;f_plotAllenMap(mean(subAvg.Spectra.lowF_highNE_Ca,2),cmp=cmpinf,mask=plotBM,cRange=[0,1]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_E2.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

f = figure;f_plotAllenMap(mean(subAvg.Spectra.lowF_highNE_Ca,2)-mean(subAvg.Spectra.lowF_lowNE_Ca,2),cmp=cmpbbr,mask=plotBM,cRange=0.3*[-1,1]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_E3.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

%% Fig Spectra E 2

f = figure;f_plotAllenMap(mean(subAvg.Spectra.medF_lowNE_Ca,2),cmp=cmpinf,mask=plotBM,cRange=[0,1]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_E4.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

f = figure;f_plotAllenMap(mean(subAvg.Spectra.medF_highNE_Ca,2),cmp=cmpinf,mask=plotBM,cRange=[0,1]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_E5.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

f = figure;f_plotAllenMap(mean(subAvg.Spectra.medF_highNE_Ca,2)-mean(subAvg.Spectra.medF_lowNE_Ca,2),cmp=cmpbbr,mask=plotBM,cRange=0.3*[-1,1]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_E6.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

%%

f = figure;f_plotAllenMap(mean(subAvg.Spectra.highF_lowNE_Ca,2),cmp=cmpinf,mask=plotBM,cRange=[0,0.4]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_E7.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

f = figure;f_plotAllenMap(mean(subAvg.Spectra.highF_highNE_Ca,2),cmp=cmpinf,mask=plotBM,cRange=[0,0.4]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_E8.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

f = figure;f_plotAllenMap(mean(subAvg.Spectra.highF_highNE_Ca,2)-mean(subAvg.Spectra.highF_lowNE_Ca,2),cmp=cmpbbr,mask=plotBM,cRange=0.1*[-1,1]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_E9.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

%% Fig Spectra F

f = figure;f_plotAllenMap(mean(subAvg.Spectra.lowF_lowNE_HbT,2),cmp=cmpinf,mask=plotBM,cRange=[0,0.15]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_F1.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

f = figure;f_plotAllenMap(mean(subAvg.Spectra.lowF_highNE_HbT,2),cmp=cmpinf,mask=plotBM,cRange=[0,0.15]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_F2.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

f = figure;f_plotAllenMap(mean(subAvg.Spectra.lowF_highNE_HbT,2)-mean(subAvg.Spectra.lowF_lowNE_HbT,2),cmp=cmpbbr,mask=plotBM,cRange=0.02*[-1,1]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_F3.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

%%

f = figure;f_plotAllenMap(mean(subAvg.Spectra.medF_lowNE_HbT,2),cmp=cmpinf,mask=plotBM,cRange=[0,0.15]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_F4.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

f = figure;f_plotAllenMap(mean(subAvg.Spectra.medF_highNE_HbT,2),cmp=cmpinf,mask=plotBM,cRange=[0,0.15]);
colorbar off;
exportgraphics(f, fullfile(fig_savePath,'ExtDataFig8_F5.jpg'),'Resolution',300,'BackgroundColor',[1 1 1]);

f = figure;f_plotAllenMap(mean(subAvg.Spectra.medF_highNE_HbT,2)-mean(subAvg.Spectra.medF_lowNE_HbT,2),cmp=cmpbbr,mask=plotBM,cRange=0.03*[-1,1]);
colorbar off;
