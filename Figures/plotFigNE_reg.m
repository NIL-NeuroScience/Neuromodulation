...
writetable(table(mean(subAvg.NE_reg.Ca_vs_HbT,3)), fullfile(fig_savePath, 'ExtDataFig9_C1.csv'));
...
writetable(table(mean(subAvg.NE_reg.Ca_vs_HbT_reg,3)), fullfile(fig_savePath, 'ExtDataFig9_C2.csv'));
...
writetable(table(mean(subAvg.NE_reg.global_Ca_vs_HbT_reg,3)), fullfile(fig_savePath, 'ExtDataFig9_C3.csv'));
...
writetable(table(mean(subAvg.NE_reg.global_Ca_vs_HbT_reg,3)), fullfile(fig_savePath, 'ExtDataFig9_D1.csv'));
...
writetable(table(mean(subAvg.NE_reg.global_Ca_vs_HbT_reg,3)), fullfile(fig_savePath, 'ExtDataFig9_D2.csv'));
...
writetable(table(mean(subAvg.NE_reg.highNE_HbT_reg,3)-mean(subAvg.NE_reg.lowNE_HbT_reg,3)), fullfile(fig_savePath, 'ExtDataFig9_D3.csv'));
...
writetable(table(mean(subAvg.NE_reg.global_Ca_vs_HbT_reg,3)), fullfile(fig_savePath, 'ExtDataFig9_E1.csv'));
...
writetable(table(mean(subAvg.NE_reg.global_Ca_vs_HbT_reg,3)), fullfile(fig_savePath, 'ExtDataFig9_E2.csv'));
...
writetable(table(mean(subAvg.NE_reg.global_highNE_HbT_reg,3)-mean(subAvg.NE_reg.global_lowNE_HbT_reg,3)), fullfile(fig_savePath, 'ExtDataFig9_E3.csv'));
