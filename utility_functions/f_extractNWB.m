...
% 
% Extracts data from nwb file pointers.
% 
% INPUTS: f_extractNWB(nwb)
%   nwb: nwb file pointer (from matNWB function nwbRead)
% 
% OUTPUTS:
...
function [rfp, gfp, rfp_HD, gfp_HD, Hb, HbO, HbT, Whisking, Pupil, ...
    Accelerometer, brain_mask, vessel_mask, allen_masks, fs, mouseInfo, ...
    sessionInfo, behCam] = f_extractNWB(nwb)
...
% extract behavior video if output
